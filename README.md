...
I modify starter code to create an application called Note Taker that can be used to write and save notes. This application will use an Express.js back end and will save and retrieve note data from a JSON file.
...
THEN the new note you entered is saved and appears in the left-hand column with the other existing notes
